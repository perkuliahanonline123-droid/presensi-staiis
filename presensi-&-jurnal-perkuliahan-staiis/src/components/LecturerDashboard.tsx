...
import { 
  BookOpen, Calendar, Clock, Plus, Edit3, Trash2, 
...
export function LecturerDashboard({ 
  ...
  const handleFreeSetAll = (status: AttendanceStatus) => {
    if (!selectedCourse) return;
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
            ...
            <div className="lg:col-span-7 bg-white p-5 rounded-2xl border border-slate-200 space-y-4 shadow-sm">
              ...
              <div className="flex flex-wrap items-center gap-2 text-xs">
                ...
                <button 
                  onClick={() => handleFreeSetAll('Hadir')} 
                ...
                <button 
                  onClick={() => handleFreeSetAll('Sakit')} 
